...
1. [Voyager 2 Plasma Experiment](./voyager/solar_wind)
    ...
    This is very much a WIP, but I'm interested in how we define 'the edge of the solar system' - it's actually a trickier question than you might think. I've started exploring some data from the [Voyager 2 Plasma Experiment](https://voyager.jpl.nasa.gov/mission/spacecraft/instruments/pls/) in a Jupyter Notebook. [Voyager 2 Plasma Experiment](./voyager/solar_wind)
